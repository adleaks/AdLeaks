...
#ifndef _OC_BUFFEREDSTREAMREADER_H_
#define _OC_BUFFEREDSTREAMREADER_H_

#include "OCBase.h"

typedef struct OCBufferedStreamReader* OCBufferedStreamReaderRef;
...
// n _must_ be smaller than bufferSize
int OCBufferedStreamReaderRead(OCBufferedStreamReaderRef sr, OCByte* buf, size_t n);
