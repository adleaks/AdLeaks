...
#ifndef _OC_DICTIONARY_H_
#define _OC_DICTIONARY_H_

#include "OCObject.h"
#include "OCString.h"

typedef struct OCDictionary* OCDictionaryRef;
typedef struct OCDictionaryIterator* OCDictionaryIteratorRef;

// a very slow but very simple dictionary
// for now: append only
